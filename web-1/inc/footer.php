<div class="footer">
    <div class="container">
        ...
        <div class="row-icon icon-social">
            <a href="index.php">
                <span class="icon">
